...
samtools view -bh -@ 12 ./mapped_reads/ERR1755082.sam > ./mapped_reads/ERR1755082.bam 
samtools sort -@ 12 ./mapped_reads/ERR1755082.bam > ./mapped_reads/sortedERR1755082.bam 
samtools index -@ 12 ./mapped_reads/sortedERR1755082.bam
